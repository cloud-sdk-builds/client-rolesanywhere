...
[`@aws-sdk/client-rolesanywhere`](https://www.npmjs.com/package/@aws-sdk/client-rolesanywhere/v/3.388.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-rolesanywhere@3.388.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-BjDf0qK4c0VOFtEYEX49on+b1GJJlaCSPt63zaaQ8/Vykaf/PVXVE/R9Ui3s5XeT
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-rolesanywhere": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-rolesanywhere@3.388.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-rolesanywhere@3.388.0/index.min.mjs": "sha384-BjDf0qK4c0VOFtEYEX49on+b1GJJlaCSPt63zaaQ8/Vykaf/PVXVE/R9Ui3s5XeT"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-rolesanywhere/blob/refs/tags/3.388.0/LICENSE
```
